...
namespace GAA3MSWeb.Migrations
{
    /// <inheritdoc />
    public partial class seedToDatabase : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InvoicePaymentTerms", x => x.PaymentTermsId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Invoices_InvoicePaymentTerms_PaymentTermsId",
                        column: x => x.PaymentTermsId,
                        principalTable: "InvoicePaymentTerms",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 3, "PO Box 85826", null, "San Diego", false, "Golden Eagle Insurance Co", "CA", "JaneSmith.GEIC@gmail.com", "Jane", "Smith", "917-544-7090", "92186" },
                    { 4, "1952 H Street", "P.O. Box 1952", "Fresno", false, "Fresno Photoengraving Company", "CA", "ChadJonesFPC@gmail.com", "Chad", "Jones", "559-555-3005", "93718" },
                    { 5, "Ohio Valley Litho Division", null, "Cincinnate", false, "Nielson", "OH", "PaulMorganOVLD@gmail.com", "Paul", "Morgan", "519-824-3477", "45264" },
                    ...
                    { 8, "Attn:  Supt. Window Services", "PO Box 7005", "Madison", false, "US Postal Service", "WI", "AlbertoFrancesco.USPS@gmail.com", "Alberto", "Francesco", "800-555-1205", "53707" }
                });

...
namespace GAA3MSWeb.Entities
{
    public class VendorDBContext : DbContext
    {
        ...
        public DbSet<PaymentTerms> InvoicePaymentTerms { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Vendor>().HasData(
                ...
                new Vendor()
                {
                    ...
                    VendorContactEmail = "JaneSmith.GEIC@gmail.com",
                ...
                new Vendor()
                {
                    ...
                    VendorContactEmail = "ChadJonesFPC@gmail.com",
                ...
                new Vendor()
                {
                    ...
                    VendorContactEmail = "PaulMorganOVLD@gmail.com",
                ...
                new Vendor()
                {
                    ...
                    VendorContactEmail = "AlbertoFrancesco.USPS@gmail.com",
